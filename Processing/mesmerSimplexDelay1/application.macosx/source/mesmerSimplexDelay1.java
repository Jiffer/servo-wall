...
public class mesmerSimplexDelay1 extends PApplet {
...
float noisePtr = 0.0f;
float noiseInc = 0.0008f; //adust correlation between neighbors
float noiseTimeInc = 0.0075f; //adjusts speed of sim
...
class Cell{
  ...
  Cell(float ex, float why){
    ...
    x = ex * cellX;
    y = why * cellY;
    nodeNum = PApplet.parseInt((pX * _numY) + pY);
...
//    line(5, 0, 5, height);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "mesmerSimplexDelay1" });
  }
}
