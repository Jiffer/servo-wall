...
public class mesmerSimplex1 extends PApplet {
...
float noiseTimeInc = 0.01f; //adjusts speed of sim
...
//    line(5, 0, 5, height);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "mesmerSimplex1" });
  }
}
