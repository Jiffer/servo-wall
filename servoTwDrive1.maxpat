...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 81.0, 237.0, 50.0, 20.0 ],
					"presentation_rect" : [ 86.0, 263.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 283.25, 336.0, 50.0, 20.0 ],
					"presentation_rect" : [ 288.0, 336.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 163.0, 276.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 410.5, 264.0, 50.0, 20.0 ],
					"presentation_rect" : [ 412.25, 264.0, 0.0, 0.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 206.0, 206.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 170.0, 57.0, 20.0 ],
									"text" : "pipe 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 261.0, 110.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 186.0, 110.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 283.25, 299.0, 147.0, 20.0 ],
					"presentation_rect" : [ 285.0, 299.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 290.25, 202.0, 50.0, 20.0 ],
					"presentation_rect" : [ 288.25, 201.0, 0.0, 0.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float" ],
									"patching_rect" : [ 261.0, 110.0, 25.0, 25.0 ],
									"presentation_rect" : [ 261.0, 115.0, 0.0, 0.0 ]
								}
...
,
					"patching_rect" : [ 163.0, 237.0, 147.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontsize" : 12.0,
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 233.25, 155.0, 50.0, 20.0 ],
					"presentation_rect" : [ 347.0, 112.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.0, 155.0, 50.0, 20.0 ],
					"presentation_rect" : [ 283.0, 111.0, 0.0, 0.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 192.0, 178.0, 0.0, 0.0 ]
								}
...
,
					"patching_rect" : [ 109.0, 184.0, 141.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontsize" : 12.0,
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 109.0, 155.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 23.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 91.840912, 610.0, 686.5, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"default_fontsize" : 12.0,
						"description" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 346.25, 697.0, 84.0, 20.0 ],
					"text" : "serial a 9600"
				}
