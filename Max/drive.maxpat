...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 789.0, 145.0, 61.0, 20.0 ],
					"text" : "r preNum"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 789.0, 183.0, 100.0, 40.0 ],
					"preset_data" : [ 						{
							"number" : 1,
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 23.952095, 0.177215, 0, 56.886227, 0.367089, 0, 110.778442, 0.493671, 0, 161.676651, 0.582278, 0, 236.526947, 0.670886, 0, 317.365295, 0.759494, 0, 395.209564, 0.835443, 0, 491.017975, 0.898734, 0, 577.84436, 0.936709, 0, 685.628784, 0.974684, 0, 750.0, 1.0, 0 ],
					"domain" : 750.0,
					"id" : "obj-1",
					"maxclass" : "function",
					"numinlets" : 1,
